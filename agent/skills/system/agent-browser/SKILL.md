...
Use a proxy to avoid IP-based blocking:
...
Add random delays between actions to mimic human interaction:
...
- [ ] Proxy configured if IP-based blocking is expected
- [ ] Saved auth state with `state save` after first login
